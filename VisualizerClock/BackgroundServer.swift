...
//  Visualizer Clock
//
//  Created by Stuart Rankin on 12/17/18.
...
class BackgroundServer
{
    ...
    public func UpdateBackgroundColors(_ GLayer: CAGradientLayer)
    {
        ...
        #else
        Gradient.add(BGAnimation, forKey: "colorChange")
        #endif
        PreviousColors = NewColors
    }
    
    /// Used to store previous gradient colors.
    var PreviousColors: [CGColor] = [UIColor.white.cgColor, UIColor.gray.cgColor, UIColor.black.cgColor]
