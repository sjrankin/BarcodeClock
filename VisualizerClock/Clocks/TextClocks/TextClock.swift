...
class TextClock: ClockProtocol
{
    ...
    private var _ClockName: String = "Text Clock"
    ...
    {
        return PanelActions.SwitchToText
    }
    ...
    private var _ClockID: UUID = UUID(uuidString: Clocks.ClockIDMap[PanelActions.SwitchToText]!)!
