...
class BarcodePDF417Clock: ClockProtocol
{
    /// Clock initializer.
    ///
    ...
    {
        return PanelActions.SwitchToPDF417
    }
    
    /// Holds the name of the clock.
    private var _ClockName: String = "PDF 417"
    ...
    func MakeBarcode(from: String) -> UIImage?
    {
        ...
        let BitmapArray = BarcodeGenerator.CreateBarcodeBitmap(from: from, WithType: "PDF417",
                                                               FinalWidth: &BitmapWidth, FinalHeight: &BitmapHeight)
        #endif
        var NotUsed: CIImage? = nil
        return BarcodeGenerator.Create(from: from, WithType: "PDF417", Foreground: FGColor,
    ...
    private var _ClockID: UUID = UUID(uuidString: Clocks.ClockIDMap[PanelActions.SwitchToPDF417]!)!//"fb5e2f66-5f65-4c3b-97f6-df143be35f6d")!
